...
pub (crate) fn build_device_repo() -> HashMap<String, Arc<RefCell<GenericDevice<MessageEnum>>>> {
    ...
    let dev_list: Vec<GenericDevice<MessageEnum>> = vec![
        GenericDevice::new("zigbee2mqtt",KITCHEN_SWITCH, MessageEnum::default_inter_switch(), false),
        ...
        GenericDevice::new("zigbee2mqtt",HALL_LAMP, MessageEnum::default_lamp_rgb(), false),
    ];
